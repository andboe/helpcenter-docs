...
3. Go to menu:Settings[ACD] in the menu bar, or right-click the selected external system and click *Configuration*.
...
Create a new external system in menu:Administration[System>External Systems] for the new Xlink ACD connection. Then configure it as described for xref:acd-integration:xlink-configuration-import-odbc.adoc[ODBC] or xref:acd-integration:xlink-configuration-import-csv.adoc[CSV].

[#operating-an-acd-test-system-in-parallel]
== Operating an ACD test system in parallel
If parallel operation of the old and new environment is requested, create the new ACD as another external system in menu:Administration[System>External Systems]. Configure it as described for xref:acd-integration:xlink-configuration-import-odbc.adoc[ODBC] or xref:acd-integration:xlink-configuration-import-csv.adoc[CSV].
