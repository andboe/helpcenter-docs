...
We release new Xlink versions with bug fixes on the [download page](https://downloads.peopleware.com/en#xlink-software-documentation). To check your current Xlink version, open the **version.txt** file or right-click the **isps_ul.exe** file and choose Properties. Then, navigate to the Details tab.
...
2. Download the _Xlink Suite_ from [downloads.peopleware.com](https://downloads.peopleware.com) and unzip the archive.
