...
In _Intraday > Intraday Adherence_{:.breadcrumbs}, you can compare people's scheduled activities with the actual activities to identify out-of-adherence periods throughout the day. Intraday adherence uses xref:intraday:real-time-adherence.adoc[real-time adherence] data from your ACD or the Time Tracking app in Me. You can access the adherence data for the current month and the last six months.

[#display-data]
== Display data
To display adherence data for a specific day, follow these steps:

1. Select a _Planning unit_{:.label} and/or a _Selection_{:.label}.
...
|Intraday adherence uses the selected planning unit's time zone. If you click a person to see the Agent Intraday Adherence details, all times appear in the _time zone_{:.css} configured in your user profile. The time zone is displayed at the top right of the adherence timeline.
|===