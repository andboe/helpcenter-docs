...
The Xlink application imports data from third-party systems such as telephone systems (ACD). The *Xlink Suite* is available for download at link:https://downloads.peopleware.com[downloads.peopleware.com].
