...
The Xlink application imports data from third-party systems such as telephone systems (ACD). The _Xlink Suite_{:.menu-item} is available for download at [downloads.peopleware.com](https://downloads.peopleware.com).
