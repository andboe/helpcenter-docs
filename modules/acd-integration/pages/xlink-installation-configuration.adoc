...
1. Download the link:https://downloads.peopleware.com/de#xlink-software-dokumentation[Xlink application] and unzip the ZIP archive.
...
[#update-xlink]
== Update Xlink
1. Download the latest version of the link:https://downloads.peopleware.com/en#xlink-software-documentation[Xlink Application].
