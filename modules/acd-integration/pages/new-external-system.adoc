...
The available Universal and CSV interface are more flexible, as you can define a format for files or tables the Xlink reads data from. The corresponding manuals for these interfaces are available at link:https://downloads.peopleware.com[downloads.peopleware.com].
