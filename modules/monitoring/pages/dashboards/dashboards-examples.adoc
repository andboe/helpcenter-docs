...
In menu:Analyze[Dashboards], you can visualize and organize your data into charts to monitor, compare and analyze key metrics, and make informed decisions. The following examples describe useful dashboard configurations.
...
1. In menu:Analyze[Dashboards], xref:monitoring:manage-dashboards.adoc#create-dashboards[create a new dashboard].
