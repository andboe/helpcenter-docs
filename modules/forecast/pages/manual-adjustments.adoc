...
If you xref:forecast:task-set-up-staff-requirement-calculation.adoc[set up the staff requirements calculation] on the workload page, you can use the new values for scheduling by clicking _Save staff requirements_{:.doc-button}.
...
3. In _Forecast > Requirement calculations_{:.breadcrumbs}, select a requirement calculation option.
