...
|===
|_WFM > Administration > System > Role Authorization > Mass Update_{:.breadcrumbs}
|_Account > Roles > Functional permissions > People_{:.breadcrumbs}
|Contracts
|Edit People
|Skills
|View and edit Roles
...
1. In the navigation bar, click the {icon-context-menu} _Job Status_{:.label}.
