...
For scheduling periods with the status Shift bidding enabled created by your planner, you will see a notification in the Notices section in {bc-me-dashboard}, and a banner in {bc-me-calendar}.

[#bid-on-shifts]
== Bid on shifts
1. In {bc-me-dashboard}, click btn:[Bid] in a shift bidding notification.  
