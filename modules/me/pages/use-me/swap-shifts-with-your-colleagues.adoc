...
3. In the section **7 Day Agenda**, click the offer icon _![Offer Button](/assets/img/common/injixo-me/offer.png)_{:.doc-button-icon} next to the shift you want to offer. The offer icon is visible if xref:scheduling:what-are-scheduling-periods.adoc#when-can-people-swap-shifts[shift swaps] are allowed for this period and shift.
...
5. Click _Swap_{:.doc-button}. If the **Auto-accept counter offers from invited people** checkbox is enabled, counteroffers are accepted automatically once you receive them.
