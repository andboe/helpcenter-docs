...
== 2. Create a time-off period
1. In menu:Plan[Time Off], create a xref:scheduling:time-off-periods-legacy.adoc#create-a-time-off-period[time-off period].
...
== 3. People submit their requests
In menu:Me[Time Off], people can xref:me:explore-me.adoc#request-time-off[submit requests] for the activity Unavailable.

[#4-approve-or-reject-requests]
== 4. Approve or reject requests
In menu:Plan[Time Off], xref:scheduling:vacation-absences-management.adoc[approve or reject time-off requests] for the activity Unavailable.<br>
...
== Keep track of the requests
In menu:Plan[Shift Center], you can see the details of approved time-off requests for the activity Unavailable.
...
Go to menu:Plan[Time Off] to xref:scheduling:vacation-absences-management.adoc#view-requests[see approved, pending and rejected requests].