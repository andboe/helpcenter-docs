...
== 1. Create the activity Unavailable
1. In _Plan > Configuration_{:.breadcrumbs} create a xref:administration:activities.adoc#create-an-activity[new activity].
...
== 2. Create a time-off period
1. In _Plan > Time Off_{:.breadcrumbs}, create a xref:scheduling:time-off-periods-legacy.adoc#create-a-time-off-period[time-off period].
...
== 3. People submit their requests
In _Me > Time Off_{:.breadcrumbs}, people can xref:me:explore-me.adoc#request-time-off[submit requests] for the activity Unavailable.

[#4-approve-or-reject-requests]
== 4. Approve or reject requests
In _Plan > Time Off_{:.breadcrumbs}, xref:scheduling:vacation-absences-management.adoc[approve or reject time-off requests] for the activity Unavailable.<br>
...
Go to _Plan > Time Off_{:.breadcrumbs} to xref:scheduling:vacation-absences-management.adoc#view-requests[see approved, pending and rejected requests].