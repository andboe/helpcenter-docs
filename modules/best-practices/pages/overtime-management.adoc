...
[#schedule-overtime]
== Schedule overtime
You can manually schedule overtime either in menu:Plan[Shift Center] or in menu:Plan[Schedules].
...
To add overtime activities in menu:Plan[Schedules], follow these steps:
