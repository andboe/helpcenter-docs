...
5. In the configuration window, configure the value type:
   - _Planning unit_{:.label} and **Activity**: From the drop-down menus, select the planning unit and activity for which you want to view the predicted service levels.
...
== Configure how predicted service levels are displayed
1. Go to _WFM > Administration > Scheduling > Planning Units_{:.breadcrumbs}.
