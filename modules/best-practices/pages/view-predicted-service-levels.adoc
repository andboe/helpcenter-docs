...
1. Go to {bc-forecast-workloads} and select the relevant workload. +
The Workloads details page opens.
...
4. Click the {icon-edit} next to the Predicted Service Level value type. +
The *Value Types* configuration window opens.
...
The *User-Defined Parameters* configuration dialog opens.
