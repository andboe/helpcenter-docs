...
The values in the volume and AHT graphs in workloads do not default to the time zone set in xref:getting-started:navigate-peopleware.adoc#your-user-profile[your user profile]. To see values according to your profile's time zone, go to _Analyze > Dashboards_{:.breadcrumbs} and add workload data to a dashboard.
