...
Regardless of the xref:scheduling:scheduling-methods.adoc[scheduling method] you use, it may turn out that some employees receive unpopular shifts more often than others because of their availability or the fact that they possess rare skills. This can quickly lead to employee dissatisfaction, a reduction in morale, and increased staff turnover.
...
image::fair-shift-distribution/image-1.png[Shift Sequences]
...
1. Create a xref:administration:availabilities.adoc[day model availability] with a length of 1 minute that sets the day to be completely unavailable.
...
== Optimized rotation: Work time pattern models
If you want to optimize shifts while applying rotating patterns, use *work time pattern models*.
...
== Unpopular shifts: Exception days
If you don’t want to assign unpopular shifts or tasks for entire weeks, but only schedule one or two per week for each employee, you can use *week time patterns* with **exception days**:

1. Create a **week time pattern** with your standard shifts.
   image::fair-shift-distribution/image-4.png[week time pattern with day models for standard shifts, width=50%]
2. In the week time pattern, enter a value of 1 (or more) in the **Maximum Number of Exception Days per Week** field to define how many unpopular shifts an employee can get within a week.
   image::fair-shift-distribution/image-3.png[Week Time Pattern Model, width=50%]
...
4. In a work time pattern model, add the week time pattern(s) with your standard shifts.
   image::fair-shift-distribution/image-5.png[work time pattern model with week time pattern(s) for standard shifts, width=50%]
5. Select the week time pattern with unpopular shifts from the **Week Time Pattern - Exception Days** drop-down menu.
   image::fair-shift-distribution/image-2.png[work time pattern model, width=50%]
