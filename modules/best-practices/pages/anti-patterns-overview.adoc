...
#### What you should do is...? <a name="what-you-should-do-is"></a>
...
Why not create an employee filter <!-- [employee filter](https://help.peopleware.com/de/employee-filter/) --> <!-- , article not available in EN? --> to get the list of employees you want to edit. Then you can use the mass update <!-- [mass update functionality](https://help.peopleware.com/de/mass-update/) --> <!-- article not available in EN? --> to update the selected employees.
