...
- _Planning unit_{:.label}: Select **All planning units**.
...
- _Planning unit_{:.label}: Make sure that no planning unit is selected.
- _Selection_{:.label}: Select **Onboarding**.
...
3. Filter by selection with the following drop-down menus:
   - _Planning unit_{:.label}: Select **Office 1**.
   - _Selection_{:.label}: Select **Onboarding**.
