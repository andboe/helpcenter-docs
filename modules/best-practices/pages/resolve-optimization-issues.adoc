...
- **Classic**: Access reports in xref:general:jobstatus.adoc[Job status] and under menu:WFM[Scheduling>SchedulePro>Optimization].
...
[#people-settings]
=== People settings
Go to menu:People[] and select the person whose settings you want to check:
