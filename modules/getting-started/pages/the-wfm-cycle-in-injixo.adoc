...
## 1. Forecasterstellung <a name="1-forecasting"></a>

### Integration einrichten <a name="set-up-an-integration"></a>
...
### Workload erstellen <a name="create-a-workload"></a>

Du kannst deine Integrationen unter _Account > Integrationen_{:.breadcrumbs} konfigurieren.

Um injixo Forecast zu nutzen, musst du zunächst {% link_new einen Workload erstellen | features/forecast/injixo-forecast/create-workloads.md | #create-workloads %}. Dazu nutzt du die Queues, die von deiner Integration importiert werden. Workloads enthalten alle deine historischen Daten und die damit verbundenen Forecasts. Damit du einen Workload erstellen kannst, muss deine ACD korrekt verbunden sein und die importierten Queues müssen verfügbar sein.

Du kannst Workloads unter _Forecast > Workloads_{:.breadcrumbs} erstellen.

### Forecast erstellen <a name="generate-a-forecast"></a>
...
### Mitarbeiterbedarf berechnen <a name="calculate-staff-requirements"></a>
...
## 3. Schichtpläne erstellen <a name="3-scheduling"></a>

### Schichten planen <a name="create-schedules"></a>
...
## 4. Tagessteuerung <a name="4-intraday-management"></a>
...
## 5. Analyse <a name="5-analytics"></a>
