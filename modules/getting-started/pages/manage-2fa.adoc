...
4. In the **Password and authentication** section, click _{icon-check-circle} Enforce 2FA_{:.doc-button}.
...
2. Select a person from the list.
3. In the left-side menu, click **Access**.
4. In the **Password and authentication** section, click _Revoke 2FA enforcement_{:.doc-button}.