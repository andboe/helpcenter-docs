...
## 2FA-Einstellungen anderer Benutzer einsehen <a name="see-other-peoples-2fa-settings"></a>
...
## 2FA-Aktivierung für andere Benutzer erzwingen <a name="enforce-2fa-activation-for-other-people"></a>
...
Bevor du 2FA für andere Benutzer erzwingst, stelle sicher, dass sie auf eine der unterstützten {% link_new Authenticator-Apps | getting-started/use-two-factor-authentication.md | #prerequisite-install-an-authenticator-app %} zugreifen können.

### 2FA-Aktivierung für einzelne Benutzer erzwingen <a name="enforce-2fa-activation-for-individual-people"></a>
...
### 2FA-Aktivierung für alle Benutzer erzwingen <a name="enforce-2fa-activation-for-everyone"></a>
...
### 2FA für einzelne Benutzer deaktivieren <a name="deactivate-2fa-for-individual-people"></a>
