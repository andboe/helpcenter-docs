...
## Was sind Objektrechte? <a name="what-are-object-access-groups"></a>
...
## Objektrechte verwalten <a name="configure-object-access"></a>
...
### Neue Objektrechte erstellen <a name="create-a-new-object-access-group"></a>
...
### Zugriff durch Objektrechte einschränken <a name="restrict-access-in-an-object-access-group"></a>
...
### Objektrechte für einen Benutzer definieren <a name="assign-an-object-access-group-to-a-user"></a>
