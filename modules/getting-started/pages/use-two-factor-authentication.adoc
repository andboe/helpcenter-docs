...
## Was ist die Zwei-Faktor-Authentifizierung? <a name="what-is-two-factor-authentication"></a>
...
## Voraussetzung: Installiere eine Authenticator-App <a name="prerequisite-install-an-authenticator-app"></a>
...
## 2FA für deinen Account aktivieren <a name="activate-2fa-for-your-account"></a>
...
1. Installiere eine der [unterstützten Authenticator-Apps](#prerequisite-install-an-authenticator-app).
...
## Anmeldung bei aktivierter 2FA <a name="log-in-when-2fa-is-active"></a>
...
### Mit einem Backup-Code anmelden <a name="log-in-with-a-backup-code"></a>
...
### Ohne privates Gerät und Backup-Codes anmelden <a name="log-in-without-your-personal-device-and-backup-codes"></a>
...
## 2FA auf einem neuen privaten Gerät verwenden <a name="use-2fa-on-a-new-personal-device"></a>

Um ein neues Gerät verwenden zu können, über das du Einmal-Passwörter erzeugst, musst du 2FA für deinen Account vorübergehend deaktivieren und dann mit deinem neuen Gerät&nbsp;[erneut aktivieren](#activate-2fa-for-your-account).
...
## 2FA für deinen Account deaktivieren <a name="deactivate-2fa-for-your-account"></a>
