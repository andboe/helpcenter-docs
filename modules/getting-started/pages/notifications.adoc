...
related_articles:
  - overwrite_title: Add title for untranslated source
    filepath: features/scheduling/schedules/notify-people.md
  - overwrite_title: Add title for untranslated source
...
## Benachrichtigungen konfigurieren <a name="configure-notifications"></a>
...
## Browser-Benachrichtigungen erlauben <a name="allow-browser-push-notifications"></a>
...
## Probleme mit Browser-Benachrichtigungen beheben <a name="fix-browser-push-notifications-issues"></a>
...
## Browser-Benachrichtigungen testen <a name="test-browser-push-notifications"></a>
