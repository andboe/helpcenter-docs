...
## IP-Filterung aktivieren <a name="activate-ip-filtering"></a>
...
Die IP-Filterung betrifft nur Interaktionen auf der Benutzeroberfläche. Ausgenommen von der IP-Filterung sind die API und der Zugriff auf das optionale Schicht Center über eine direkte URL.

## IP-Adressbereiche bearbeiten <a name="edit-the-ip-address-ranges"></a>
...
## IP-Filterung deaktivieren <a name="deactivate-ip-filtering"></a>
