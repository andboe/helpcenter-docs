...
## Browser-Anforderungen <a name="browser-requirements"></a>
...
## Pop-up-Blocker <a name="pop-up-blocker"></a>
...
## Microsoft Edge im Internet Explorer (IE)-Modus <a name="microsoft-edge-in-internet-explorer-ie-mode"></a>
...
## injixo Client Software <a name="injixo-client-software"></a>
...
### URLs für WebSockets freigeben <a name="share-urls-for-websockets"></a>
...
## Anforderungen an die Netzwerk-Bandbreite <a name="network-bandwidth-requirements"></a>
...
## Integrationsanforderungen <a name="integration-requirements"></a>
...
## Rechenzentrum und Sicherheitsvorkehrungen <a name="data-center-and-security-provisions"></a>
