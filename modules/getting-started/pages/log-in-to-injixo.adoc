...
## Über den Browser auf injixo zugreifen <a name="access-injixo-through-your-browser"></a>
...
Nach der Anmeldung werden Mitarbeiter mit der Rolle {% link_new Standard Agent | features/account/default-user-roles.md | #the-standard-agent-role %} zu ihrer {% link_new Übersicht | features/injixo-me/use-injixo-me/explore-injixo-me.md | #alles-auf-einen-blick-übersicht- %} in Me weitergeleitet. Mitarbeiter mit {% link_new anderen Rollen | features/account/default-user-roles.md | #the-standard-agent-role %} werden zur Startseite von injixo weitergeleitet.

## Abmelden <a name="log-out"></a>
...
## Passwort zurücksetzen <a name="reset-password"></a>
