...
[NOTE]
====
If you don't have the Classic WFM plan, use the xref:scheduling:break-optimization.adoc[Optimize breaks], xref:scheduling:schedules-job-optimization.adoc[Job optimization] and xref:scheduling:schedules-optimized-schedules.adoc[Create optimized schedules] functionality under _Plan > Schedules_{:.breadcrumbs} instead.
====
...
Under _WFM > Scheduling > SchedulePro > Optimization_{:.breadcrumbs}, finished optimizations display a report icon that links to the xref:best-practices:resolve-optimization-issues.adoc[scheduling report]. The report helps you to understand any scheduling errors in case they occur.
...
4. Select a _Planning Unit_{:.label}.
5. (Optional) Under _Selection_{:.label}, use the default **[All]** or pick a selection from the drop-down menu.
