...
[NOTE]
====
If you don't have the Classic WFM plan, use the xref:scheduling:break-optimization.adoc[Optimize breaks], xref:scheduling:schedules-job-optimization.adoc[Job optimization] and xref:scheduling:schedules-optimized-schedules.adoc[Create optimized schedules] functionality under {bc-plan-schedules} instead.
====
...
Under {bc-wfm-scheduling-schedulepro-optimization}, finished optimizations display a report icon that links to the xref:best-practices:resolve-optimization-issues.adoc[scheduling report]. The report helps you to understand any scheduling errors in case they occur.
...
=== Create optimized schedules
1. Go to {bc-wfm-scheduling-schedulepro-optimization}.
