...
[NOTE]
====
If you are using Essential WFM, Advanced WFM or Enterprise WFM, use the function xref:scheduling:schedules-insert-shift-sequences.adoc[Insert Shift Sequences] under _Plan > Schedules_{:.breadcrumbs}.
====
[#set-parameters]
== Set parameters
...
2. Confirm your parameters with _Create Employee List_{:.doc-button}. The xref:#employee-list[employee list] appears.
...
- _2602_{:.id-label} Max. activity duration
- _2611_{:.id-label} _Check employee availability_
- _2613_{:.id-label} Max. shifts per day
