...
[NOTE]
====
If you use Advanced WFM or Enterprise WFM, use the function xref:scheduling:use-levels.adoc[Copy level content] under menu:Plan[Schedules] instead.
====
[#what-are-levels]
== What are levels
...
7. Click *![edit button](/assets/img/common/item-edit.gif)*.
