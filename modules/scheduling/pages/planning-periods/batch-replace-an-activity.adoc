...
[NOTE]
====
If you use Advanced WFM or Enterprise WFM, use the function xref:scheduling:schedules-replace-activities.adoc[Replace activities] under menu:Plan[Schedules] instead.
====
...
2. Click btn:[Exchange] in the section _Activity_.
...
8. To start the replacement, click btn:[Ok].
