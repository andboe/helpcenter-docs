...
[NOTE]
====
If you use Advanced WFM or Enterprise WFM, use the function xref:scheduling:schedules-replace-activities.adoc[Replace activities] under {bc-plan-schedules} instead.
====
