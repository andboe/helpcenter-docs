...
== Display the activities area
1. In _Plan > Schedules_{:.breadcrumbs}, set the xref:scheduling:schedules-overview.adoc#filter-data[filters] and the xref:scheduling:schedules-overview.adoc#schedule-area[view options].
