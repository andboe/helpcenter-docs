...
== Prevent overwriting of scheduled activities
By default, when you insert full-day activities into the schedule using shift sequences, other full-day activities are overwritten in the schedule, e.g. time off. To prevent this, activate the scheduling rule _2645_{:.id-label} _Disallow overwriting of full-day activities with shifts or activities_.

By default, partial-day activities of the types Absence, Illness, Vacation, or Meeting are not overwritten.

To delete activities of all types when inserting a shift sequence, check the checkbox **Delete all activities and shifts** to avoid errors related to the scheduling rule _2648_{:.id-label} _Write protection for activities in the Shift Center_, which is always active for shift sequence insertion.
