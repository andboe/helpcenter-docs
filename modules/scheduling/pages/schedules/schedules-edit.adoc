...
4. Click btn:[Add new Activity] to create a new activity for which you can define a start and end time or btn:[Add new Full-Day Activity] to create a new xref:administration:activity-types-and-properties.adoc#activity-properties[full-day activity]. +
...
6. If your activity is not a full-day activity, enter the *Start Time* and *End Time* for the new activity. +
If an activity starts the day before, or ends the day after, you can change the date of its start time or end time. +
To add more activities, repeat steps 4 to 6.
...
3. Click the {icon-x} next to the activity or activities that you want to delete. Click the icon again to deselect the activity or activities.  +
To delete all activities currently displayed on the page, click btn:[Delete all Activities].
4. At the bottom left, click btn:[Save].
...
3. In the page that opens, click the *History* tab. +
At the top right of the page, you can see the person's current shift. Below, you see a table with five columns:
   - Checkbox column
