...
4. Click _Add new Activity_{:.doc-button} to create a new activity for which you can define a start and end time or _Add new Full-Day Activity_{:.doc-button} to create a new xref:administration:activity-types-and-properties.adoc#activity-properties[full-day activity].<br>
