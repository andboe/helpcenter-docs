...
2. Use the **Create optimized schedule** functionality.<br>Your rotating and fully flexible shifts are scheduled in a way that complements the coverage provided by the shift sequences.
...
For this use case, you can add xref:administration:daymodel-basics.adoc#types-of-day-models[day models of the type Availability] to xref:administration:shift-sequences.adoc[shift sequences] to influence the scheduling result on particular days.<br>See the two examples below.
