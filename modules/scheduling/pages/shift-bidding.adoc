...
- Your employees can request the generated shifts via _Me_{:.menu-item}.
...
[NOTE]
====
If you use Advanced WFM or Enterprise WFM, use scheduling periods under _Plan > Schedules_{:.breadcrumbs} for xref:scheduling:schedules-shift-bidding.adoc[shift bidding] instead.
====
Take note:
...
The assignment randomly assigns shifts to employees for which there were no or too few requests in _Me_{:.menu-item}.
...
== Edit the generated shifts
In _Plan > Shift Center_{:.breadcrumbs}, you can check the generated shifts by day and edit the number of required shifts if necessary. To edit the shifts, proceed as follows:
